...
Msb4 skin enables CSS pop-ups for image links on the website using [Lightbox 2][lightbox].
...
Msb4 skin enables smooth scrolling for in-page navigation (e.g. for table of contents links).
...
[Bootstrap][bootstrap] provides nice CSS effects for certain elements, such as tables, etc. Msb4
...
To match [Bootstrap][bootstrap] themes, Msb4 skin replaces some icons used by Maven site with
...
Previously anchors used the `<a name="...">` element. Msb4 transforms these `<a>` anchors
...
The Msb4 skin is released under the [Apache license][apache-license] and thus can be used freely.
By default, a link to the skin website and the author homepage is added at the bottom of the skin:
_Msb4 Maven skin by Marek Romanowski_. I would appreciate if you kept the link - it will help with
